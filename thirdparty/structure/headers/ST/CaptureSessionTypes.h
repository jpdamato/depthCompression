...
/** @brief Describes the Camera Type connected to the Structure Core sensor. */
enum class DynamicCalibrationState
{
    /** Dynamic calibration default state: Stopped */
    Stopped = 0,

    /** Dynamic calibration is in progress */
    InProgress,

    /** Dynamic calibration has been succeeded */
    Succeeded,
};
...
struct ST_API CaptureSessionSample
{
    ...
    /** @brief Convert the enum to a readable string. @see DynamicCalibrationState */
    static const char* toString(DynamicCalibrationState state);
